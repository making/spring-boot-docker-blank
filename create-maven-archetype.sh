...
sed -i -e "s/spring-boot-docker-blank/projectName/g" pom.xml
sed -i -e "s/github\.com\/making\/projectName/github.com\/making\/spring-boot-docker-blank/g" pom.xml
...
sed -i -e "s/projectName/spring-boot-docker-blank/g" pom.xml
